...
`;
  ...
  console.log(`     Rename the file if your platform requires a different filename.`);
  console.log(`     You know where your platform stores skills (whether you are`);
  console.log(`     Claude, Codex, Cursor, or other agent).`);
